...
(function() {
  var Errors, Stats, escape, fs, isAppendable, isFunction, isReadable, isWritable;
  ...
  fs = (function() {
    ...
    fs.prototype.writeSync = function(fd, buffer, offset, length, position) {
      ...
      if (!isWritable(this.__fileDescriptors[fd].flags)) {
    ...
    fs.prototype.readSync = function(fd, buffer, offset, length, position) {
      ...
      path = this.__fileDescriptors[fd].path;
      if (!isReadable(this.__fileDescriptors[fd].flags)) {
