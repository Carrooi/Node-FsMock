...
(function() {
  var Errors, Readable, Stats, Writable, escape, fs, isAppendable, isFunction, isReadable, isWritable, toDate, _path;
  ...
  fs = (function() {
    ...
    fs.prototype.createWriteStream = function(path, options) {
      ...
      ws.on('finish', function() {
        var fd;
        fd = _this.openSync(path, options.flags, options.mode);
        _this.writeSync(fd, new Buffer(data, options.encoding), 0, data.length, 0);
